 ...
 *  Copyright (C) 2013-2014 by Tetsuya Morizumi
 *
 ...
 * 
 *  @(#) $Id: tinet_target_config.h 13 2012-03-28 12:57:24Z tetsuya $
 */
...
#define NUM_IF_EMACLITE_TXBUF   2       /* 送信バッファ数                       */
#define NUM_IF_EMACLITE_RXBUF   2       /* 受信バッファ数                       */

#define TMO_IF_EMACLITE_GET_NET_BUF 1   /* [ms]、受信用 net_buf 獲得タイムアウト    */
#define TMO_IF_EMACLITE_XMIT    (2*IF_TIMER_HZ) /* [s]、 送信タイムアウト           */
...
/*
 *  NIC (Ethernet Lite Mac) に関する定義
 */

#define XEMACLITE_BASE          ULONG_C(0x40E00000) /* NIC のレジスタベースアドレス */
...
#define NUM_MPF_NET_BUF_CSEG    4       /* IF + IP + TCP、2 以上*/

 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: xps_timer.h 5 2012-01-14 09:35:55Z tetsuya $
 */
...
{
	return(TO_CLOCK(TIC_NUME, TIC_DENO) - sil_rew_mem((void*)XTIMER_TCR0));
}
...
{
	return((sil_rew_mem((void*)XTIMER_TCSR0) & XTIMER_TCSR_INT_BIT) == XTIMER_TCSR_INT_BIT);
}
